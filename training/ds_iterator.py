...
class DataIterator(object):
    ...
    def __init__(self, h5file, batch_size, data_shape, label_shape, split_point, shuffle=False, seed=None):
    ...
    def next(self):
        with self.lock:
            ...
            for k in batch_keys:
                ...
                batches_y1.append(lbl_all[np.newaxis, :self.split_point,:,:])
                batches_y2.append(lbl_all[np.newaxis, self.split_point:, :, :])
